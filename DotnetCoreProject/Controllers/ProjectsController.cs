...
namespace DotnetCoreProject.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(DotnetCoreProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Projects != null ? 
                          ...
                          Problem("Entity set 'DotnetCoreProjectContext.Projects'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DotnetCoreProjectContext.Projects'  is null.");
            }
            var project = await _context.Projects.FindAsync(id);
            if (project != null)
            {
